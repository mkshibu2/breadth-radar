...
║  Version 3.2  |  Data: Yahoo Finance + NSE CSV  |  by Shibu          ║
║                                                                      ║
...
def generate_html(results, scan_time, total_scanned, errors, rejects, sector_stats):
    ...
    # FIX: Added `overflow-x:auto` and changed table `white-space` to `nowrap` for mobile scrolling
    ...
    # FIX: Changed `min-width:500px` to `min-width:280px` on the flex:2 container
